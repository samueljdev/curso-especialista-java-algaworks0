...
/* Uma financeira contratou um programador para desenvolver um programa que calcula o custo total de
empréstimos para seus clientes, porém o contrato foi cancelado e você foi chamado para concluir a
programação do sistema. O cliente também te informou que a taxa de juros da financeira depende da
quantidade de parcelas: 1 ou 2 parcelas: 1,99% ao mês
3 parcelas: 2,99% ao mês, Outras quantidades de parcelas: 3,99% ao mês
